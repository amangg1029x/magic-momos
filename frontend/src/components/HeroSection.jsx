        ...
        <svg className="absolute inset-0 w-full h-full opacity-[0.04]">
          <defs>
            <pattern id="dots" x="0" y="0" width="32" height="32" patternUnits="userSpaceOnUse">
              <circle cx="1.5" cy="1.5" r="1.5" fill="#2A1E1B" />
            </pattern>
          </defs>
            ...
            {STATS.map(({ icon: Icon, value, label }) => (
              <div key={label} className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="font-body text-[11px] text-mm-muted uppercase tracking-wider leading-none mt-0.5">
                    {label}
                  </p>
                </div>
              </div>
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -top-3 -right-2 bg-mm-red text-white
                         ...
                         shadow-[0_0_14px_rgba(232,40,75,0.5)]"
            >
              ⭐ Best Seller
            </motion.div>
